        ...
        <div className="">
            {mainNews.length > 0 ? (
                <div className='md:flex'>
                    ...
                    <div className="flex flex-row md:flex-row items-start mb-4 border rounded-lg overflow-hidden shadow-md w-full md:w-3/5 md:h-3/5">
                            ...
                            <Link to={`/blog/${blog._id}`} className="gap-2 mx-2">
                                ...
                                {index < 2 && (
                                    <div className="md:w-full">
                                        ...
                                        src={blog.image}
                                        alt={blog.title}
                                        className="hidden md:block h-40 w-full aspect-video transition-transform duration-300 ease-in-out transform hover:scale-105"
                                        />
                                    </div>
                                )}
